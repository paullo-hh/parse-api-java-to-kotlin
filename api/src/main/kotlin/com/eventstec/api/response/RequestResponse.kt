package com.eventstec.api.response
...
class ResponseRequest<T> : Serializable {

    var status: HttpStatus = HttpStatus.OK
    var message: String = ""
    var messages: ArrayList<String> = arrayListOf()
    var messagesOBJ: ArrayList<MutableMap<String, Any>> = arrayListOf()
    var data: T? = null
    ...
    constructor(data: T?,messages: ArrayList<MutableMap<String, Any>>) : super() {
        this.status = HttpStatus.OK
...
//            it.defaultMessage?.let { it1 -> this.messages.add(it1) }
//        }
        this.message = ""
    }
